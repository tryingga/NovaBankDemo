...
struct ProfileView: View {
    ...
    var body: some View {
        NavigationStack {
            ScrollView {
                VStack(spacing: Theme.Spacing.l) {
                    ...
                    SettingsSection(title: "Preferenze") {
                        ...
                        SettingsToggleRow(icon: "faceid", title: "Face ID", isOn: $faceIDEnabled)
                    }

                    SettingsSection(title: "Sicurezza") {
                        SettingsNavRow(icon: "lock.fill", title: "Sicurezza account")
                        Divider().padding(.leading, 52)
                        SettingsNavRow(icon: "key.fill", title: "Cambia PIN")
                    }
            ...
            .pageHeaderActions()
            .confirmationDialog("Vuoi uscire dall'account?", isPresented: $showLogoutConfirm, titleVisibility: .visible) {
